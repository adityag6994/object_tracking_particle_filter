...
int main(int argc, char **argv)
{
    ...
    ros::init(argc,argv,"tracking_object_1");
    ros::NodeHandle nh;
    ...
    pub_praticles_cloud=nh.advertise<sensor_msgs::PointCloud2>("particles_cloud_1",1);
    pub_result_cloud=nh.advertise<sensor_msgs::PointCloud2>("result_cloud_1",1);
    pub_down_cloud=nh.advertise<sensor_msgs::PointCloud2>("cloud_pass_downsampled_1",1);
